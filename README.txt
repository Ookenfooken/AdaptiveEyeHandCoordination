...
Generates matlab plots of the distribution of reach onsets relative to the last detected letter change (6A&B) and the response time
to the cue relative to the time of reach following a detected letter change before the cue (6C&D).
Saves 'letterDetectViewTime.mat' to analyze task performance in R (compareDetectionTask.R).
