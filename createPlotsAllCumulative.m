...
orangeFT = [253,174,107]./255;
orangeTW = [241,105,19]./255;
...
for j = 3:4
    ...
    % plot
    if j < 4
        selectedColour = orangeFT;
    else
        selectedColour = orangeTW;
    end
    figure(10)
    hold on
    plot(nansum(ballFixOnsetsReach)/max(nansum(ballFixOnsetsReach)), 'Color', selectedColour, 'LineWidth', 2)
    plot(nansum(ballFixOffsetsReach)/max(nansum(ballFixOffsetsReach)), '--', 'Color', selectedColour, 'LineWidth',2)
    ...
    figure(11)
    hold on
    plot(nansum(ballFixOnsetsApproach)/max(nansum(ballFixOnsetsApproach)), 'Color', selectedColour, 'LineWidth', 2)
    plot(nansum(ballFixOffsetsApproach)/max(nansum(ballFixOffsetsApproach)), '--', 'Color', selectedColour, 'LineWidth',2)
    line([shift shift], [0 1], 'Color', gray)
    line([0 vectorLength], [.5 .5], 'Color', gray)
    xlim([0 vectorLength])
    ...
    figure(12)
    hold on
    plot(nansum(ballFixOnsetsGrasp)/max(nansum(ballFixOnsetsGrasp)), 'Color', selectedColour, 'LineWidth', 2)
    plot(nansum(ballFixOffsetsGrasp)/max(nansum(ballFixOffsetsGrasp)), '--', 'Color', selectedColour, 'LineWidth',2)
    line([shift shift], [0 1], 'Color', gray)
    line([0 vectorLength], [.5 .5], 'Color', gray)
    xlim([0 vectorLength])
    ...
    figure(13)
    hold on
    plot(nansum(ballFixOnsetsTransport)/max(nansum(ballFixOnsetsTransport)), 'Color', selectedColour, 'LineWidth', 2)
    plot(nansum(ballFixOffsetsTransport)/max(nansum(ballFixOffsetsTransport)), '--', 'Color', selectedColour, 'LineWidth',2)
    line([shift shift], [0 1], 'Color', gray)
    line([0 vectorLength], [.5 .5], 'Color', gray)
    xlim([0 vectorLength])
