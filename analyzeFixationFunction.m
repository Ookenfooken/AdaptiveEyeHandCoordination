...
participantBallDots = NaN(numParticipants,6);
...
ballFixFunction = [3*ones(numParticipants,1) ones(numParticipants,1) participantBallDots(:,1); ...
    3*ones(numParticipants,1) 2*ones(numParticipants,1) participantBallDots(:,3); ...
    3*ones(numParticipants,1) 3*ones(numParticipants,1) participantBallDots(:,5); ...
    4*ones(numParticipants,1) ones(numParticipants,1) participantBallDots(:,2); ...
    4*ones(numParticipants,1) 2*ones(numParticipants,1) participantBallDots(:,4); ...
    4*ones(numParticipants,1) 3*ones(numParticipants,1) participantBallDots(:,6)];
%%
...
participantSlotDots = NaN(numParticipants,6);
for pat = 1:numParticipants
...
slotFixFunction = [3*ones(numParticipants,1) ones(numParticipants,1) participantSlotDots(:,1); ...
    3*ones(numParticipants,1) 2*ones(numParticipants,1) participantSlotDots(:,3); ...
    3*ones(numParticipants,1) 3*ones(numParticipants,1) participantSlotDots(:,5); ...
    4*ones(numParticipants,1) ones(numParticipants,1) participantSlotDots(:,2); ...
    4*ones(numParticipants,1) 2*ones(numParticipants,1) participantSlotDots(:,4); ...
    4*ones(numParticipants,1) 3*ones(numParticipants,1) participantSlotDots(:,6)];
%%
